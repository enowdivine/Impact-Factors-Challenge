...
// Distribution map for users in their current country
...
// List of West African countries where users originate from
...
> = {
  Switzerland: [
    { city: "Zurich", region: "Zurich", postalCode: "8001" },
    { city: "Geneva", region: "Geneva", postalCode: "1201" },
    { city: "Basel", region: "Basel-Stadt", postalCode: "4051" },
    { city: "Bern", region: "Bern", postalCode: "3001" },
    { city: "Lausanne", region: "Vaud", postalCode: "1001" },
    { city: "Lucerne", region: "Lucerne", postalCode: "6003" },
    { city: "St. Gallen", region: "St. Gallen", postalCode: "9001" },
    { city: "Lugano", region: "Ticino", postalCode: "6900" },
  ],

  Canada: [
    { city: "Toronto", region: "Ontario", postalCode: "M5G 1X6" },
    { city: "Vancouver", region: "British Columbia", postalCode: "V5K 0A1" },
    { city: "Montreal", region: "Quebec", postalCode: "H3B 3Y5" },
    { city: "Calgary", region: "Alberta", postalCode: "T2P 1J9" },
    { city: "Edmonton", region: "Alberta", postalCode: "T5J 3G7" },
    { city: "Ottawa", region: "Ontario", postalCode: "K1P 1J1" },
    { city: "Winnipeg", region: "Manitoba", postalCode: "R3B 3L3" },
    { city: "Quebec City", region: "Quebec", postalCode: "G1K 3M8" },
    { city: "Halifax", region: "Nova Scotia", postalCode: "B3J 1B5" },
  ],

  Cameroon: [
    { city: "Yaoundé", region: "Centre", postalCode: "00237" },
    { city: "Douala", region: "Littoral", postalCode: "00237" },
    { city: "Bamenda", region: "Northwest", postalCode: "00237" },
    { city: "Bafoussam", region: "West", postalCode: "00237" },
    { city: "Garoua", region: "North", postalCode: "00237" },
    { city: "Maroua", region: "Far North", postalCode: "00237" },
    { city: "Ngaoundéré", region: "Adamawa", postalCode: "00237" },
    { city: "Bertoua", region: "East", postalCode: "00237" },
    { city: "Ebolowa", region: "South", postalCode: "00237" },
    { city: "Kumba", region: "Southwest", postalCode: "00237" },
  ],
};
...
export const fetchRandomImage = async (gender: string) => {
  try {
    ...
    // Use nationalities where Black people are predominant
    const blackNationalities = ["NG", "GH", "ZA", "KE", "JM"]; // Nigeria, Ghana, South Africa, Kenya, Jamaica

    // Randomly select one nationality from the list
    const randomNat =
      blackNationalities[Math.floor(Math.random() * blackNationalities.length)];

    const response = await axios.get(
      `https://randomuser.me/api/?gender=${apiGender}&nat=${randomNat}`
    );
...
const generateRandomUser = async (country: Country, gender: string) => {
  ...
  // Select a random city, region, and postal code from the country
  const locationData = faker.helpers.arrayElement(
    countryCities[countryOfOrigin.name as keyof typeof countryCities]
  );
